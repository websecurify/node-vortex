...
Provider.prototype.bootstrap = function (nodeName, callback) {
	...
	node.roost.bootstrap.push('sudo ifconfig eth1 0.0.0.0 0.0.0.0 && sudo ifconfig eth2 0.0.0.0 0.0.0.0 && sudo dhclient -r eth1 eth2 && sudo dhclient eth1 eth2 && sleep 10');
