...
function shell(opt, provider, name, node, manifest, callback) {
...
function provision(opt, provider, name, node, manifest, callback) {
...
function status(opt, provider, name, node, manifest, callback) {
...
function boot(opt, provider, name, node, manifest, callback) {
...
function halt(opt, provider, name, node, manifest, callback) {
...
function reload(opt, provider, name, node, manifest, callback) {
...
function launch(opt, manifest, plugins, provider, action, callback) {
	...
	Object.keys(map).forEach(function (name) {
		...
		exports[action](opt, map[name].nodeProvider, name, map[name].node, manifest, function (err) {
			if (err) {
				return callback(err);
			}
