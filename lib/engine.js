...
function shell(provider, name, node, manifest, callback) {
...
function provision(provider, name, node, manifest, callback) {
...
function status(provider, name, node, manifest, callback) {
...
function boot(provider, name, node, manifest, callback) {
...
function halt(provider, name, node, manifest, callback) {
...
function reload(provider, name, node, manifest, callback) {
