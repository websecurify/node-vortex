(function() {
  exports.main = function(argv) {
    ...
    */
    ...
    opt = node_getopt.create([['f', 'file=ARG', 'Specify the root of a vortex project or a vortex manifest.'], ['p', 'provider=ARG', 'Specify a default provider.'], ['d', 'dry', 'Dry run the roost manifest.'], ['v', 'verbose+', 'Make it verbose.'], ['c', 'colorize', 'Make it pretty.'], ['h', 'help', 'Display this help.']]);
    opt = opt.bindHelp();
    opt = opt.parse(argv);
